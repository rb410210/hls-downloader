...
public class HlsDownloaderApplication {
	...
	private final String ARG_OUT_FILE = "file";
	private final String CLI_SYNTAX = "hls-download [options...] <url>";
	private final String OPT_HELP = "h";
	private final String OPT_KEY = "k";
	private final String OPT_KEY_LONG = "force-key";
	private final String OPT_OUT_FILE = "o";
	private final String OPT_OUT_FILE_LONG = "output";
	private final String OPT_SILENT = "s";
	private final String OPT_OVERWRITE = "y";


	public static void main(String[] args) {
		final ConfigurableApplicationContext ctx = SpringApplication.run(HlsDownloaderApplication.class, args);
		ctx.getBean(HlsDownloaderApplication.class).execute(args);
	}
